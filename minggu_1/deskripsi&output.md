...
=========================================
Tim Anda harus menghasilkan empat komponen utama di akhir minggu pertama:
...
4. Analisis Tertulis: Penjelasan singkat (sekitar setengah halaman) yang menguraikan bagaimana konsep aritmetika modulo diterapkan di dalam kode program. (Catatan: Draf untuk teks ini sudah saya siapkan di dokumen panduan pada poin 4).